...
ranks_pr = make_array_of_file("p2p-Gnutella04-pagerank-ranks.txt")
ranks_dr = make_array_of_file("p2p-Gnutella04-dirichlet-ranks.txt")
values_pr = make_array_of_file_float("p2p-Gnutella04-pagerank-values.txt")
values_dr = make_array_of_file_float("p2p-Gnutella04-dirichlet-values.txt")
