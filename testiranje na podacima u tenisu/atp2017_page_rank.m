...
for( i = 1:nmatches )
    ...
    % pobjednik pokazuje na gubitnika - tako pobjednici imaju bolji rank
    G( winner, loser ) = G( winner, loser ) + 1;
end;
...
newplot();
hold on
plot( y(1:490), 'o' ); % igraci iza 491. mjesta na ATP listi nemaju niti jednu pobjedu
plot( 1:490 );
corr( 1:490, y(1:490) )
corr( 1:100, y(1:100) )
