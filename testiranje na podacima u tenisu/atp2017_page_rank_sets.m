...
for( i = 1:nmatches )
    ...
    % brojimo osvojene setove
    G( winner, loser ) = G( winner, loser ) + matches(i,3);
    G( loser, winner ) = G( loser, winner ) + matches(i,4);
end;
...
newplot();
hold on
plot( y(1:490), 'o', 'color', 'g' ); % igraci iza 491. mjesta na ATP listi nemaju niti jednu pobjedu
plot( 1:490 );
corr( 1:490, y(1:490) )
corr( 1:100, y(1:100) )
